...
namespace BSB.Data.Migrations
{
    ...
    [Migration("20210830044215_CommentsOnPosts")]
    partial class CommentsOnPosts
    {
            ...
            modelBuilder.Entity("BSB.Data.Entity.CommentInPost", b =>
                {
                    b.HasOne("BSB.Data.Entity.Comment", "Comment")
                        ...
                        .HasForeignKey("BSB.Data.Entity.CommentInPost", "CommentId")
